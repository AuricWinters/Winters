  ...
  <div class="auth-page">
    ...
    <div class="auth-container">
      ...
      <div class="form-section">
        <div class="auth-card card-spotlight" v-spotlight :class="{ shake: shakeCard }">
          <!-- 标签切换 -->
            ...
            <div class="form-group" :class="{ 'has-error': errors.username }">
              ...
              <div class="input-wrapper">
                <input
                  ...
                  @focus="isTyping = true"
                >
                <div v-if="form.username" class="input-clear" @click="form.username = ''">
            ...
            <div class="form-group" :class="{ 'has-error': errors.email }">
              ...
              <div class="input-wrapper">
                <input
                  ...
                  @focus="isTyping = true"
                >
                <div v-if="form.email" class="input-clear" @click="form.email = ''">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
                    <circle cx="12" cy="12" r="10" stroke-width="2" />
                    <path d="M15 9l-6 6M9 9l6 6" stroke-width="2" stroke-linecap="round" />
                  </svg>
